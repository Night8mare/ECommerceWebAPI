...
{
    public class AdminCreateCommandValidator : AbstractValidator<AdminCreateCommand>
    {
        public AdminCreateCommandValidator(IGenericRepository<User> _user) 
        {
            ...
            Log.Information("Validating City min field..");
            ...
            RuleFor(u => u.Role)
                ...
                .Must(value => value != null && value.Equals("Admin") || value.Equals("User") || value.Equals("Support")).WithMessage("Roles available [User, Support, Admin]");
            Log.Information("Validating Role field..");
        }
    }
}
